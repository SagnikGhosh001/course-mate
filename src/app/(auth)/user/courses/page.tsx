      ...
      <main className="max-w-7xl mx-auto">
        {enrollCourse.length === 0 ? (
          <div className="text-center text-gray-600 dark:text-gray-400 animate-fade-in">
            <p className="text-lg">You haven’t enroll any courses yet.</p>
            <Button
              asChild
              variant="link"
              className="mt-2 text-teal-600 dark:text-teal-400"
            >
              <Link href="/course/all-course">Start by joining a course!</Link>
            </Button>
          </div>
        ) : (
            ...
            {enrollCourse.map((course, index) => (
              ...
              >
                ...
                <CardFooter className="flex-col items-center">
                  ...
                  <p>
                    Cart At:- {new Date(course.createdAt).toLocaleDateString()}
                  </p>
                </CardFooter>
              </Card>
            ))}
